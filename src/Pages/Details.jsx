        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">No option to schedule bulk messages</a>
              </li>
             
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Limited scope</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Non-incorporation of Artificial Intelligence</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Difficult-to-understand user interface:</a>
              </li>
            </ul>
          </div>
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  ...
                  <p></p>
                  <p>   </p>
<p>A lot of such existing applications do not
...
customers on a specific time;</p>
              ...
              <div class="tab-pane" id="tab-3">
                <div class="row">
                  ...
                  <p>A lot of existing applications and softwares allow users to schedule
              ...
              <div class="tab-pane" id="tab-4">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3></h3>
                    <p class="fst-italic"></p>
                    <p>AI-powered text messaging refers to the
              ...
              <div class="tab-pane" id="tab-5">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3></h3>
                    <p class="fst-italic"></p>
                 <p>The most important aspect for a user to use
